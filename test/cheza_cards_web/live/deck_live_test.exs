defmodule ChezaCardsWeb.DeckLiveTest do
  use ChezaCardsWeb.ConnCase

  import Phoenix.LiveViewTest
  import ChezaCards.CardsFixtures

  @create_attrs %{name: "some name", description: "some description", is_public: true, is_premium: true}
  @update_attrs %{name: "some updated name", description: "some updated description", is_public: false, is_premium: false}
  @invalid_attrs %{name: nil, description: nil, is_public: false, is_premium: false}
