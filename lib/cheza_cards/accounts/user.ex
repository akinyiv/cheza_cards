defmodule ChezaCards.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, ChezaCards.Repo)
  ...
  """
  def valid_password?(%ChezaCards.Accounts.User{hashed_password: hashed_password}, password)
